 ...
 */
@NotThreadSafe
public class PravegaInputSplit implements InputSplit, WritableComparable<PravegaInputSplit> {
    ...
    // Needed for reflection instantiation: WritableComparable interface
